...
local bundles = {
    vim.fn.glob(
    "/home/rmuhamedgaliev/.local/share/nvim/mason/packages/java-debug-adapter/extension/server/com.microsoft.java.debug.plugin-*.jar"
    ),
}
vim.list_extend(bundles,
    vim.split(vim.fn.glob("/home/rmuhamedgaliev/.local/share/nvim/mason/packages/java-test/extension/server/*.jar"), "\n"))
